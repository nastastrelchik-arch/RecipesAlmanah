...
urlpatterns = [
    ...
    path('recipe/<int:pk>/remove-favorite/', views.remove_favorite, name='remove-favorite'),
    path('recipe/<int:pk>/remove-favorite/', views.remove_from_favorites, name='remove-from-favorites'),
]